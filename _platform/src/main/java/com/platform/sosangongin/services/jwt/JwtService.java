...
public interface JwtService {
    String createToken(UUID userId, UserAgentDto userAgent);
    String createToken(UUID userId, UserAgentDto userAgent, UUID businessId, List<Role> roles);
    String createRefreshToken(UUID userId, UserAgentDto userAgent);
