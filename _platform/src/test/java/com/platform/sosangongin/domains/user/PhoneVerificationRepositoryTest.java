...
class PhoneVerificationRepositoryTest {
    ...
    void savePhoneVerification() {
        ...
        PhoneVerification verification = new PhoneVerification(code, expiredAt);
    ...
    void verifySuccess() {
        // given
        PhoneVerification verification = new PhoneVerification("123456", LocalDateTime.now().plusMinutes(3));
    ...
    void verifyExpired() {
        ...
        PhoneVerification verification = new PhoneVerification("123456", expiredAt);
        phoneVerificationRepository.save(verification);
